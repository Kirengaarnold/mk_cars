      ...
      <div className="bg-white rounded-lg shadow p-6">
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6">
          <div>
            ...
            <p className="text-sm text-gray-600">Add new employees or view the current employee list.</p>
          </div>
          <div className="flex gap-2">
            <button type="button" onClick={() => setView('create')} className={`px-4 py-2 rounded-lg transition ${view==='create' ? 'bg-blue-600 text-white' : 'bg-gray-100 text-gray-800 hover:bg-gray-200'}`}>
              Add Employee
            </button>
            <button type="button" onClick={() => setView('list')} className={`px-4 py-2 rounded-lg transition ${view==='list' ? 'bg-blue-600 text-white' : 'bg-gray-100 text-gray-800 hover:bg-gray-200'}`}>
              Employee List
            </button>
          </div>
        </div>
